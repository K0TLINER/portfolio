      ...
      <Card>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            알로리즘을 단순히 해결 방법이 아닌 해결 방법을 찾는 방법에 대한
            블로그
          </Typography>
          <Typography variant="body2" color="text.secondary">
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              ...
              경험해보지 않은 개발자는 없을 것이다.
              <br />
              검색해서 비슷한거나 동일한 경우를 찾더라도 나는 왜 안되지 이런
              경우가 꽤 있다. 이 경험을 겪은 뒤 생각을 해봤는데 검색해서 모든
              것을 해결한다면 chatGPT가 모두 학습해서 다 해결하면 되지
              않을까라는 생각이 들었습니다.
              <br />
              그런데 그렇게는 되지 않을것 같습니다. 왜나하면 사람마다 하드웨어가
              다르고 운영체제가 다르고 버전이 다르고 사용하는 국가도 다르고 어떤
              툴의 버전 및 설정값이 동일하지 않습니다.
              <br />
              사실 상 완벽히 동일한 환경일 수 없으니 해결되는 문제도 있고 안되는
            ...
            <Typography paragraph>
              ...
              왜 풀어야하는 가?"라고 생각하는 것보단 "이런 문제가 언젠간
              비지니스에 필요하다면 어떻게 하드웨어 자원을 최소환으로 쓰며
              효율적으로 풀 수 있을까?"라는 질문으로 바꾸면서 동기부여가
              되었습니다.
            </Typography>
            <Typography paragraph>
              제가 알고리즘을 풀면서 느낀점이 일단 시간복잡도 및 공간복잡도를
              논리적으로 분석한 뒤 실현이 가능하다고 증명및 판단되면 그 때 특정
            ...
            <Typography paragraph>
              ...
              생각했고 그 중 파이썬이 가장 좋다고 판단했기 때문에 선택했습니다.
            </Typography>
            <Typography paragraph>
              논리적인 생각을 할 때 머릿속으로 해결하는 것은 정말 천재의 영역인
              것 같습니다. 저는 똑똑하지 못해서 종이나 태블릿에 쓰면서 합니다.
              그래서 태블릿 필기앱에 많은 알고리즘에 대한 생각을 정리한 자료가
              정리되어 있습니다. 그 중 하나만 업로드했습니다. <br />
              <Link href="https://aeye.tistory.com" target="_blank">
                알고리즘 PDF
              </Link>
            </Typography>
            ...
            <Typography paragraph>
              ...
              얻어집니다. 문제를 분석하고 그 분석에 대한 논리를 생각해보고 시간
